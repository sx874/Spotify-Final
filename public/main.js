// code taken from https://github.com/simondevyoutube/ThreeJS_Tutorial_3DWebsite and their YT tutorial //
...
class Website3DDemo {
  ...
  _Initialize() {
    ...
    this._camera.position.set(0, 7, 30);
    ...
    this._LoadAnimatedModelAndPlay(
        './resources/model/', 'michelle.fbx',
        'Samba Dancing.fbx', new THREE.Vector3(0, 0, 0));
